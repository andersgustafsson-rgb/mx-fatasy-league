...
TRACK_GEO: dict[str, dict[str, Any]] = {
    ...
    # Pro Motocross
    "Fox Raceway National": {"lat": 33.3653, "lon": -117.2290, "city": "Pala, CA", "timezone": "America/Los_Angeles"},
    "Hangtown Classic": {"lat": 38.5816, "lon": -121.4944, "city": "Sacramento, CA", "timezone": "America/Los_Angeles"},
    "Thunder Valley National": {"lat": 39.7392, "lon": -105.1781, "city": "Lakewood, CO", "timezone": "America/Denver"},
    "High Point National": {"lat": 40.7859, "lon": -80.1442, "city": "Mt. Morris, PA", "timezone": "America/New_York"},
    "RedBud National": {"lat": 41.8273, "lon": -86.3611, "city": "Buchanan, MI", "timezone": "America/Detroit"},
    "Southwick National": {"lat": 42.0548, "lon": -72.7704, "city": "Southwick, MA", "timezone": "America/New_York"},
    "Spring Creek National": {"lat": 44.2911, "lon": -94.4611, "city": "Millville, MN", "timezone": "America/Chicago"},
    "Washougal National": {"lat": 45.5826, "lon": -122.3534, "city": "Washougal, WA", "timezone": "America/Los_Angeles"},
    "Unadilla National": {"lat": 42.6251, "lon": -75.3324, "city": "New Berlin, NY", "timezone": "America/New_York"},
    "Budds Creek National": {"lat": 38.4432, "lon": -76.7439, "city": "Mechanicsville, MD", "timezone": "America/New_York"},
    "Ironman National": {"lat": 40.0417, "lon": -86.8745, "city": "Crawfordsville, IN", "timezone": "America/Indiana/Indianapolis"},
    # WSX
    "Buenos Aires City GP": {"lat": -34.6037, "lon": -58.3816, "city": "Buenos Aires", "timezone": "America/Argentina/Buenos_Aires"},
    "Canadian GP": {"lat": 51.0717, "lon": -114.1217, "city": "Calgary", "timezone": "America/Edmonton"},
    "British GP": {"lat": 52.4436, "lon": -1.9400, "city": "Birmingham", "timezone": "Europe/London"},
    "New Zealand GP": {"lat": -43.5321, "lon": 172.6362, "city": "Christchurch", "timezone": "Pacific/Auckland"},
