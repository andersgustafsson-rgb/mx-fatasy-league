...
(function (global) {
  ...
  const DICT = {
    ...
    'picks.update':          { sv: 'Uppdatera mina val', en: 'Update my picks' },
    'picks.submitted_btn':   { sv: 'Inlämnat ✓',         en: 'Submitted ✓' },
    ...
    'picks.submitted_ready': { sv: 'Inlämnat! Dina val är registrerade. Redigera om du vill ändra innan deadline.', en: 'Submitted! Your picks are registered. Edit if you want to change them before the deadline.' },
    ...
    'picks.draft_note':      { sv: 'Utkast sparas automatiskt på den här enheten. Lämna in för att registrera hos tävlingen.', en: 'Draft saved automatically on this device. Submit to register with the competition.' },
    'picks.draft_note_submitted': { sv: 'Dina val är registrerade hos tävlingen. Redigera och uppdatera om du vill ändra innan deadline.', en: 'Your picks are registered with the competition. Edit and update if you want to change them before the deadline.' },
