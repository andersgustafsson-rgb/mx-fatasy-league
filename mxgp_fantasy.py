...
_MXGP_2026_ROSTER: list[tuple[str, str, int | None, str | None, str | None]] = [
    ...
    # MX2
    ("Guillem Farres", CLASS_MX2, None, "Triumph", "Triumph Racing Factory Team"),
    ("Camden McLellan", CLASS_MX2, None, "Triumph", "Triumph Racing Factory Team"),
    ("Sacha Coenen", CLASS_MX2, None, "KTM", "Red Bull KTM Factory Racing"),
    ("Simon Längenfelder", CLASS_MX2, 1, "KTM", "Red Bull KTM Factory Racing"),
    ("Liam Everts", CLASS_MX2, None, "Husqvarna", "Nestaan Husqvarna Factory Racing"),
    ("Janis Martins Reisulis", CLASS_MX2, None, "Yamaha", "Monster Energy Yamaha Factory MX2"),
    ("Karlis Alberts Reisulis", CLASS_MX2, None, "Yamaha", "Monster Energy Yamaha Factory MX2"),
    ("Valerio Lata", CLASS_MX2, None, "Honda", "Honda HRC"),
    ("Julius Mikula", CLASS_MX2, None, "KTM", "Osicka MX Team"),
    ("Kay Karssemakers", CLASS_MX2, None, "Kawasaki", "DRT Kawasaki"),
    ("Mathis Valin", CLASS_MX2, None, "Kawasaki", "Kawasaki Racing Team MX2"),
    ("Ferruccio Zanchi", CLASS_MX2, None, "Ducati", "Beddini Racing Ducati"),
    ("Maxime Grau", CLASS_MX2, None, "Honda", "Honda"),
    ("Noel Zanocz", CLASS_MX2, None, "KTM", "Van Venrooy KTM"),
]
